...
namespace CookBook.Migrations
{
    ...
    [Migration("20260210104021_MakeQuantityUnitsNotNullable")]
    partial class MakeQuantityUnitsNotNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CookBook.Models.JwtToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CookBook.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CookBook.Models.JwtToken", b =>
                {
                    b.HasOne("CookBook.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("CookBook.Models.JwtToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
